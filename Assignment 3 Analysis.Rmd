...
### Approach Summary:
I performed a detailed analysis of the publication, "Visualizing A Stochastic Model of California Water Resources Using Sankey Diagrams" (Curmi et al. 2013), I gathered the groundwater inputs and outputs for 2000 and the projections for 2050.  Using these values I created a simple net mass balance for the net change in groundwater at year 2000 and 2050. This net groundwater change equals the inputs minus the outputs.  I used the data analysis software called R to perform my analysis.  The input and output values were put into to a liner model (regression) for years 2000 to 2050. The results of the regression was used to calculate the change in the groundwater storage each year. 
  ...
  The net groundwater storage was then calculated for 2000 to 2050.  Git
